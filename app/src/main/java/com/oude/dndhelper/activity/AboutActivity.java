        ...
        public void handleMessage(Message msg)
        {
            switch (msg.what)
            {
                ...
                case HaveUpdate:
                    ...
                    version_desc.setText(response.getDescribe());
                    version_pwd.setText(response.getPwd());
                ...
                case Latest:
                    ...
                    break;
                case TimeOut:
                    Toast.makeText(AboutActivity.this, AboutActivity.this.getResources().getText(R.string.Error_TimeOut), Toast.LENGTH_SHORT).show();
                    break;
                case InternalServerError:
                    Toast.makeText(AboutActivity.this, AboutActivity.this.getResources().getText(R.string.Error_Intenet), Toast.LENGTH_SHORT).show();
                    break;
                case BadGatWay:
                    Toast.makeText(AboutActivity.this, AboutActivity.this.getResources().getText(R.string.Error_BadGatway), Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;                
            }
        ...
        call.enqueue(new Callback(){
                ...
                public void onResponse(Call p1, Response p2) throws IOException
                {
                    ...
                    try
                    {
                        ...
                        if (getVersionCode(AboutActivity.this) < response.getCode())
                        {
                            Message message = new Message();  
